...
impl Square {
    ...
    pub const fn new(col: usize, row: usize) -> Self {
        ...
        Self(NonZeroU8::new(128 | (col * 9 + row) as u8).unwrap())
    }
    ...
    pub const fn index(self) -> usize {
        self.0.get() as usize & 127
    }
    pub const fn from_index(x: usize) -> Self {
        debug_assert!(x < 81);
        Self(NonZeroU8::new(128 | x as u8).unwrap())
    }

    pub fn shift(&mut self, dir: crate::direction::Direction) {
